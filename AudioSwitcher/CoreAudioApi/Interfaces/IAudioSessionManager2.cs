...
namespace AudioSwitcher.CoreAudioApi.Interfaces
{
	...
	public partial interface IAudioSessionManager2
    {
        ...
        /// <param name="sessionControl">Receives an <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IAudioSessionControl"/> interface for the audio session.</param>
        ...
        int GetAudioSessionControl(
            ...
            [Out] [MarshalAs(UnmanagedType.Interface)] out AudioSwitcher.CoreAudioApi.Interfaces.IAudioSessionControl sessionControl);
        ...
        /// <param name="sessionId">A new or existing session ID.</param>
        /// <param name="streamFlags">Audio session flags.</param>
        /// <param name="audioVolume">Receives an <see cref="AudioSwitcher.CoreAudioApi.Interfaces.ISimpleAudioVolume"/> interface for the audio session.</param>
        /// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
        [PreserveSig]
        int GetSimpleAudioVolume(
            [In, Optional] [MarshalAs(UnmanagedType.LPStruct)] Guid sessionId,
            [In] [MarshalAs(UnmanagedType.U4)] UInt32 streamFlags,
            [Out] [MarshalAs(UnmanagedType.Interface)] out AudioSwitcher.CoreAudioApi.Interfaces.ISimpleAudioVolume audioVolume);
		...
		int GetSessionEnumerator(
			[Out] [MarshalAs(UnmanagedType.Interface)] out AudioSwitcher.CoreAudioApi.Interfaces.IAudioSessionEnumerator sessionList);
		...
		int RegisterSessionNotification(
			[In] AudioSwitcher.CoreAudioApi.Interfaces.IAudioSessionNotification client);
		...
		int RegisterDuckNotification(
			...
			[In] AudioSwitcher.CoreAudioApi.Interfaces.IAudioVolumeDuckNotification client);
