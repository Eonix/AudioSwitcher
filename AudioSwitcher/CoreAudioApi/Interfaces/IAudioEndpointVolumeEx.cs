...
namespace AudioSwitcher.CoreAudioApi.Interfaces
{
    ...
    public partial interface IAudioEndpointVolumeEx
    {
        ...
        /// </summary>
        /// <param name="client">The <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IAudioEndpointVolumeCallback"/> interface that is registering for notification callbacks.</param>
        /// <returns>An HRESULT code indicating whether the operation passed of failed.</returns>
        [PreserveSig]
        int RegisterControlChangeNotify(
            [In] AudioSwitcher.CoreAudioApi.Interfaces.IAudioEndpointVolumeCallback client);

        /// <summary>
        /// Deletes the registration of a client's notification callback interface.
        /// </summary>
        /// <param name="clientCallback">The <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IAudioEndpointVolumeCallback"/> interface that previously registered for notification callbacks.</param>
        /// <returns>An HRESULT code indicating whether the operation passed of failed.</returns>
        [PreserveSig]
        int UnregisterControlChangeNotify(
            [In] AudioSwitcher.CoreAudioApi.Interfaces.IAudioEndpointVolumeCallback clientCallback);
