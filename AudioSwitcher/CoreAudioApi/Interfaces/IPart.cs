...
namespace AudioSwitcher.CoreAudioApi.Interfaces
{
	...
	public partial interface IPart
    {
        ...
        /// <param name="control">Receives the <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IControlInterface"/> interface of the specified audio function.</param>
        /// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
        [PreserveSig]
        int GetControlInterface(
            [In] [MarshalAs(UnmanagedType.U4)] UInt32 index,
            [Out] [MarshalAs(UnmanagedType.Interface)] out AudioSwitcher.CoreAudioApi.Interfaces.IControlInterface control);

        /// <summary>
        /// Retrieves a list of all the parts that reside on data paths that are upstream from this part.
        /// </summary>
        /// <param name="partList">Receives an <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IPartsList"/> interface that encapsulates the list of parts that are immediately upstream from this part.</param>
        /// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
        [PreserveSig]
        ...
        /// </summary>
        /// <param name="partList">Receives an <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IPartsList"/> interface that encapsulates the list of parts that are immediately downstream from this part.</param>
        /// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
        [PreserveSig]
        ...
        /// <summary>
        /// Gets a reference to the <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IDeviceTopology"/> interface of the device topology object that contains this part.
        /// </summary>
        /// <param name="deviceTopology">Receives the <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IDeviceTopology"/> interface of the device topology object.</param>
        /// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
        [PreserveSig]
        int GetTopologyObject(
            [Out] [MarshalAs(UnmanagedType.Interface)] out AudioSwitcher.CoreAudioApi.Interfaces.IDeviceTopology deviceTopology);
		...
		/// <summary>
		/// Registers the <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IControlChangeNotify"/> interface, which the client implements to receive notifications of status changes in this part.
		/// </summary>
		/// <param name="interfaceId">The function-specific control interface that is to be monitored for control changes.</param>
		/// <param name="client">A client object that implements the <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IControlChangeNotify"/> interface.</param>
		/// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
		[PreserveSig]
		int RegisterControlChangeCallback(
			[In] ref Guid interfaceId,
			[In] AudioSwitcher.CoreAudioApi.Interfaces.IControlChangeNotify client);

		/// <summary>
		/// Removes a previous registration of an <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IControlChangeNotify"/> interface.
		/// </summary>
