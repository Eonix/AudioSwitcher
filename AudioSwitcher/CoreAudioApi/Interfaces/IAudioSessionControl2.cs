...
namespace AudioSwitcher.CoreAudioApi.Interfaces
{
	...
	public partial interface IAudioSessionControl2
    {
        ...
        /// </summary>
        /// <param name="client">A client-implemented <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IAudioSessionEvents"/> interface.</param>
        /// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
        [PreserveSig]
        int RegisterAudioSessionNotification(
            [In] AudioSwitcher.CoreAudioApi.Interfaces.IAudioSessionEvents client);
