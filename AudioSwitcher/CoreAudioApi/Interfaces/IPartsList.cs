...
{
    /// <summary>
	/// Represents a list of parts, each of which is an object with an <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IPart"/> interface that represents a connector or subunit.
    /// </summary>
    /// <remarks>
	...
	public partial interface IPartsList
    {
		...
		/// <param name="part">Receives the <see cref="AudioSwitcher.CoreAudioApi.Interfaces.IPart"/> interface of the specified part object.</param>
		/// <returns>An HRESULT code indicating whether the operation succeeded of failed.</returns>
		[PreserveSig]
		int GetPart(
